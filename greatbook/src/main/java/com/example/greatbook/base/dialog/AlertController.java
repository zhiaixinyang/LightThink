...
public class AlertController {
    private BaseAlertDialog myAlertDialog;
    private Window window;
    public AlertController(BaseAlertDialog myAlertDialog, Window window) {
        this.myAlertDialog=myAlertDialog;
        this.window=window;
    }

    public BaseAlertDialog getMyAlertDialog() {
        return myAlertDialog;
    }



    public void setMyAlertDialog(BaseAlertDialog myAlertDialog) {
        this.myAlertDialog = myAlertDialog;
    }
