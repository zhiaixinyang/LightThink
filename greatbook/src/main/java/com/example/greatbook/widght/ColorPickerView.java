...
public class ColorPickerView extends FrameLayout {
    ...
    private void getAttrs(AttributeSet attrs) {
        ...
        try {
            if (a.hasValue(R.styleable.ColorPickerView_cp_src))
                imageViewDrawable = a.getDrawable(R.styleable.ColorPickerView_cp_src);
            if (a.hasValue(R.styleable.ColorPickerView_cp_selector))
                selectorDrawable = a.getDrawable(R.styleable.ColorPickerView_cp_selector);
        } finally {
            a.recycle();
        }
    }
