...
/**
 * Created by MDove on 2017/1/23.
 */

public class MyHorinzontalProgressBarView extends ProgressBar {
    protected int reachColor = ContextCompat.getColor(App.getInstance().getContext(), R.color.blue_dark_progress);
    protected int unReachColor = ContextCompat.getColor(App.getInstance().getContext(), R.color.trans_blue_dark_progress
    );
    ...
    protected int textColor = ContextCompat.getColor(App.getInstance().getContext(), R.color.blue_dark_progress);
