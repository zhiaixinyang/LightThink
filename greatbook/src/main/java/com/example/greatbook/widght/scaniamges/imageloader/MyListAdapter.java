...
public class MyListAdapter extends CommonListAdapter<String>
{
	...
	public MyListAdapter(Context context, List<String> mDatas, int itemLayoutId,
                         String dirPath)
	{
	...
	@Override
	public void convert(final ListViewHolder helper, final String item)
	{
		//设置no_pic
